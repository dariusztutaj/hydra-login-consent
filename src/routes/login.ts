...
function authenticate(email: string, password: string): UserData {
    let namespaceAdminEmail = "namespace.admin@kyma.cx";
    let developerEmail = "developer@kyma.cx";
    let noRightsUserEmail = "no-rights-user@kyma.cx";
    let readOnlyUserEmail = "read-only-user@kyma.cx";
    let adminEmail = "admin@kyma.cx";
    let defaultPassowrd = "1234";
